...
getConfusion(y_test, predictions(best_model_wt_1, X_test), "DS2_best_model")
...
plt.savefig("results/perceptron/DS2_boundary")
...
getConfusion(y_test, predictions(best_model_wt_2, X_test), "DS4_best_model")
...
plt.xlabel("Feature 1")
plt.ylabel("Feature 2")
plt.savefig("results/perceptron/DS4_boundary")
