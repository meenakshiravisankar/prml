...
for i in range(len(C_vals)):
    ...
    plt.savefig("results/svmlinker/DS4_boundary_"+str(i))
    plt.clf()
...
for i in range(len(degrees)):
    for j in range(len(C_vals)):
        ...
        plt.xlabel("Feature 1")
        plt.ylabel("Feature 2")
        plt.savefig("results/svmpolyker/DS4_boundary_degreeInd_"+str(i)+"_CInd_"+str(j))
        plt.clf()
...
for i in range(len(gammas)):
    for j in range(len(C_vals)):
        ...
        plt.xlabel("Feature 1")
        plt.ylabel("Feature 2")
        plt.savefig("results/svmrbfker/DS4_boundary_gammaInd_"+str(i)+"_CInd_"+str(j))
        plt.clf()
