...
for i in range(len(C_vals)):
    ...
    plt.savefig("results/svmlinker/DS2_boundary_"+str(i))
    plt.clf()
...
for i in range(len(degrees)):
    for j in range(len(C_vals)):
        ...
        plt.xlabel("Feature 1")
        plt.ylabel("Feature 2")
        plt.savefig("results/svmpolyker/DS2_boundary_degreeInd_"+str(i)+"_CInd_"+str(j))
        plt.clf()
...
for i in range(len(gammas)):
    for j in range(len(C_vals)):
        ...
        plt.xlabel("Feature 1")
        plt.ylabel("Feature 2")
        plt.savefig("results/svmrbfker/DS2_boundary_gammaInd_"+str(i)+"_CInd_"+str(j))
        plt.clf()

    np.savetxt('results/svmrbfker/Train_acc_ds2',acc_rbf_train,fmt='%.2f')
    np.savetxt('results/svmrbfker/Val_acc_ds2',acc_rbf_val,fmt='%.2f')
    np.savetxt('results/svmrbfker/Test_acc_ds2',acc_rbf_test,fmt='%.2f')
